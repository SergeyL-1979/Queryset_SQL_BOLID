...
class Eventonmodificationdata(models.Model):
    id = models.AutoField(db_column='ID')  # Field name made lowercase.
    changedate = models.DateTimeField(db_column='ChangeDate', primary_key=True)  # Field name made lowercase.
...
class Querylog(models.Model):
    ...
    query = models.BinaryField(db_column='Query', blank=True, null=True)  # Field name made lowercase.
...
class LogsChangeBd(models.Model):
    ...
    num = models.AutoField(db_column='Num', unique=True)  # Field name made lowercase.
    workstation = models.CharField(db_column='Workstation', max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Plogdata(models.Model):
    ...
    hozorgan = models.IntegerField(db_column='HozOrgan', blank=True, null=True)  # Field name made lowercase.
